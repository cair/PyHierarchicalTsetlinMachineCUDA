...
tm = TsetlinMachine(args.clauses, args.T, args.s, number_of_state_bits=args.number_of_state_bits, boost_true_positive_feedback=args.boost_true_positive_feedback, hierarchy_structure=((tm.AND_GROUP, 3), (tm.OR_ALTERNATIVES, args.or_alternatives), (tm.AND_GROUP, 2), (tm.OR_ALTERNATIVES, args.or_alternatives), (tm.AND_GROUP, 2)))
