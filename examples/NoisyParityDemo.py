...
tm = TsetlinMachine(args.clauses, args.T, args.s, q=args.q, weighted_clauses=False, number_of_state_bits=args.number_of_state_bits, boost_true_positive_feedback=args.boost, hierarchy_structure=((tm.AND_GROUP, 2), (tm.OR_ALTERNATIVES, args.or_alternatives)))
