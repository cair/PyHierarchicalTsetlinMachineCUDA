...
tsetlin_machine = TsetlinMachine(args.clauses, args.T, args.s, weighted_clauses=True, number_of_state_bits=8, boost_true_positive_feedback=args.boost, hierarchy_structure=((tm.AND_GROUP, 18), (tm.OR_ALTERNATIVES, args.or_alternatives), (tm.AND_GROUP, 4), (tm.OR_ALTERNATIVES, args.or_alternatives), (tm.AND_GROUP, 4)))
